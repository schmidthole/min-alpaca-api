...
class AlpacaClient:
    ...
    def _get(self, path, version='v2', payload={}):
        rsp = requests.get(f'{self.baseurl}{version}{path}',
    ...
    def _data_get(self, path, version='v1', payload={}):
        rsp = requests.get(f'{self.dataurl}{version}{path}',
                           headers=self._make_headers(),
                           params=payload)
        rsp.raise_for_status()
        return rsp.json()
    ...
    def _post(self, path, version='v2', json={}):
        rsp = requests.post(f'{self.baseurl}{version}{path}',
                            headers=self._make_headers(),
                            json=json)
        rsp.raise_for_status()
        return rsp.json()
    ...
    def _put(self, path, version='v2', json={}):
        rsp = requests.put(f'{self.baseurl}{version}{path}',
                           headers=self._make_headers(),
                           json=json)
        rsp.raise_for_status()
        return rsp.json()
    ...
    def _delete(self, path, version='v2', payload={}):
        rsp = requests.delete(f'{self.baseurl}{version}{path}',
                              headers=self._make_headers(),
                              params=payload)
        rsp.raise_for_status()
        return rsp
